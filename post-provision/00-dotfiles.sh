...
sudo -u $USER_USER -H -i bash -c "cd /home/$USER_USER && git clone git@github.com:voycey/dotfiles.git .dotfiles && source /home/$USER_USER/.dotfiles/dotfiles"
echo -e "Installing for 'root' user..."
cd /root && git clone git@github.com:voycey/dotfiles.git .dotfiles && source /root/.dotfiles/dotfiles
